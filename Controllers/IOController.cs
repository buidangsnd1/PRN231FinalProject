...
namespace Controllers
{
    public class IOController : IIOController
    {
        ...
        public void LoadDataList(List<Item> items, List<Customer> customers, List<Discount> discounts, List<BillDetail> billDetails)
        {
            try {
        ...
        public bool SaveDataList(List<Item> itemList, List<Customer> customerList, List<Discount> discountList, List<BillDetail> billDetailList)
        {
            var itemObj = new
            {
                items = itemList
            ...
            WriteData(billObj, BILL_FILE_NAME); 
            return true;
        }
