...
namespace Models
{
    public class BillDetail : Bill
    {
        ...
        public BillDetail(int billId, Cart cart, DateTime createdTime, int totalItem, long subTotal, long totalDiscountAmount, 
            long totalAmount, string status, string paymentMethod, string staffName)
